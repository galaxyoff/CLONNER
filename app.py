...
def admin():
    ...
    <body>
        <div class="container">
            ...
            {% endwith %}
            <div class="stats">
                <div class="stat-card"><div class="stat-number">{{ users|length }}</div><div>Total</div></div>
                <div class="stat-card"><div class="stat-number">{{ admins }}</div><div>Admins</div></div>
                <div class="stat-card"><div class="stat-number">{{ users|length - admins }}</div><div>Users</div></div>
            </div>
            <div class="box">
                <h3>➕ Criar Usuário</h3>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="/admin/deletar" style="display:inline;">
                                    ...
                                    <button type="submit" class="btn" style="background:#dc3545;padding:5px 10px;font-size:12px;">✕</button>
                                </form>
                                {% endif %}
                            </td>
                        </tr>
